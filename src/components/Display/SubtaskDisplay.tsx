	...
	return (
		...
		>
			{subtasks.map((subtask) => (
				<div
					className={
						"transition duration-100 hover:bg-slate-200 dark:hover:bg-zinc-800 text-sm rounded px-1 py-1 flex flex-row space-x-4 m-1 justify-between items-center cursor-pointer " +
						(subtask.completed
